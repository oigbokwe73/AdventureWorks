...
namespace AdventureWorks.Controllers
{
    public class AWBuildVersionController : ApiController
    {
        ...
        public void Post(AWBuildVersion value)
        {
            adventureWorks_BC.AWBuildVersionAdd(value);
        }

        // PUT api/awbuildversion/5
        public void Put(AWBuildVersion value)
        {
            ...
            if (GetActionType.Key != null)
            {
                if (GetActionType.Value.ToList()[0].Equals("DELETE"))
                    adventureWorks_BC.AWBuildVersionDelete(value);
                if (GetActionType.Value.ToList()[0].Equals("UPDATE"))
                    adventureWorks_BC.AWBuildVersionUpdate(value);
            }
        }
