...
namespace AdventureWorksDAL.DataContext
{
	...
	public partial class AdventureWorksDataContextDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertIllustration1(Illustration1 instance);
    partial void UpdateIllustration1(Illustration1 instance);
    partial void DeleteIllustration1(Illustration1 instance);
    ...
    partial void InsertvProductAndDescription(vProductAndDescription instance);
    partial void UpdatevProductAndDescription(vProductAndDescription instance);
    partial void DeletevProductAndDescription(vProductAndDescription instance);
    #endregion
		
		public AdventureWorksDataContextDataContext() : 
				base(global::AdventureWorksDAL.Properties.Settings.Default.AdventureWorks2008R2ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public AdventureWorksDataContextDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdventureWorksDataContextDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdventureWorksDataContextDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdventureWorksDataContextDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Illustration1> Illustration1s
		{
			get
			{
				return this.GetTable<Illustration1>();
			}
		}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<PurchaseOrderDetail> PurchaseOrderDetails
		{
			...
			{
				if ((this.serializing 
							&& (this._PurchaseOrderDetails.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<PurchaseOrderHeader> PurchaseOrderHeaders
		{
			...
			{
				if ((this.serializing 
							&& (this._PurchaseOrderHeaders.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<SalesOrderHeader> SalesOrderHeaders
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesOrderHeaders.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<ProductVendor> ProductVendors
		{
			...
			{
				if ((this.serializing 
							&& (this._ProductVendors.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<PersonCreditCard> PersonCreditCards
		{
			...
			{
				if ((this.serializing 
							&& (this._PersonCreditCards.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<CountryRegionCurrency> CountryRegionCurrencies
		{
			...
			{
				if ((this.serializing 
							&& (this._CountryRegionCurrencies.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<CurrencyRate> CurrencyRates1
		{
			...
			{
				if ((this.serializing 
							&& (this._CurrencyRates1.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<SalesOrderDetail> SalesOrderDetails
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesOrderDetails.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<SalesOrderHeaderSalesReason> SalesOrderHeaderSalesReasons
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesOrderHeaderSalesReasons.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<Store> Stores
		{
			...
			{
				if ((this.serializing 
							&& (this._Stores.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._Stores;
		...
		public EntitySet<SalesPersonQuotaHistory> SalesPersonQuotaHistories
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesPersonQuotaHistories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<SalesTerritoryHistory> SalesTerritoryHistories
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesTerritoryHistories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<SalesPerson> SalesPersons
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesPersons.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<StateProvince> StateProvinces
		{
			...
			{
				if ((this.serializing 
							&& (this._StateProvinces.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<BillOfMaterial> BillOfMaterials
		{
			...
			{
				if ((this.serializing 
							&& (this._BillOfMaterials.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<WorkOrderRouting> WorkOrderRoutings
		{
			...
			{
				if ((this.serializing 
							&& (this._WorkOrderRoutings.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
	...
	public partial class ProductModelIllustration : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Illustration1> _Illustration1;
    ...
    partial void OnModifiedDateChanged();
		...
		public int IllustrationID
		{
			...
			set
			{
				...
				{
					if ((this._Illustration.HasLoadedOrAssignedValue || this._Illustration1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Illustration1_ProductModelIllustration", Storage="_Illustration1", ThisKey="IllustrationID", OtherKey="IllustrationID", IsForeignKey=true)]
		public Illustration1 Illustration1
		{
			get
			{
				return this._Illustration1.Entity;
			}
			set
			{
				Illustration1 previousValue = this._Illustration1.Entity;
				if (((previousValue != value) 
							|| (this._Illustration1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Illustration1.Entity = null;
						previousValue.ProductModelIllustrations.Remove(this);
					}
					this._Illustration1.Entity = value;
					if ((value != null))
					{
						value.ProductModelIllustrations.Add(this);
						this._IllustrationID = value.IllustrationID;
					...
					this.SendPropertyChanged("Illustration1");
				}
			}
		}
		...
		private void Initialize()
		{
			...
			this._Illustration1 = default(EntityRef<Illustration1>);
			OnCreated();
		}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<TransactionHistory> TransactionHistories
		{
			...
			{
				if ((this.serializing 
							&& (this._TransactionHistories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<BillOfMaterial> BillOfMaterials1
		{
			...
			{
				if ((this.serializing 
							&& (this._BillOfMaterials1.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Production.Illustration")]
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class Illustration1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Illustration1_ProductModelIllustration", Storage="_ProductModelIllustrations", ThisKey="IllustrationID", OtherKey="IllustrationID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=4, EmitDefaultValue=false)]
		public EntitySet<ProductModelIllustration> ProductModelIllustrations
		{
			get
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<PersonPhone> PersonPhones
		{
			...
			{
				if ((this.serializing 
							&& (this._PersonPhones.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<EmailAddress> EmailAddresses
		{
			...
			{
				if ((this.serializing 
							&& (this._EmailAddresses.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<BusinessEntityContact> BusinessEntityContacts
		{
			...
			{
				if ((this.serializing 
							&& (this._BusinessEntityContacts.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<SalesTaxRate> SalesTaxRates
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesTaxRates.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<SalesTerritory> SalesTerritories
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesTerritories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<EmployeeDepartmentHistory> EmployeeDepartmentHistories
		{
			...
			{
				if ((this.serializing 
							&& (this._EmployeeDepartmentHistories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<BusinessEntityAddress> BusinessEntityAddresses
		{
			...
			{
				if ((this.serializing 
							&& (this._BusinessEntityAddresses.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
	...
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class vProductAndDescription : INotifyPropertyChanging, INotifyPropertyChanged
	{
